...
heatplot(edox, showCategory = 20000, foldChange = genes)
...
p3 <- dotplot(keggResult, showCategory=145, xtitleFont=c(14,"bold", "#993333"),
                ytitleFont=c(14,"bold", "#993333")) + ggtitle("dotplot for SIRT5cor_all Data")
theme_set(theme_gray(base_size = 0.01))
plot_grid(p3, ncol=1)
...
heatplot.enrichResult(keggX, showCategory = 30, foldChange = NULL)
enrichRe
